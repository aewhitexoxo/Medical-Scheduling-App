...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1L, "user1", "user1", "ROLE_USER","first","last");
    protected static final User USER_2 = new User(2L, "user2", "user2", "ROLE_USER","first","last");
    private static final User USER_3 = new User(3L, "user3", "user3", "ROLE_USER","first","last");
    ...
    public void create_user_with_null_username() {
        sut.create(null,"first", "last", USER_3.getPassword(), "ROLE_USER");

    }

    @Test(expected = DataIntegrityViolationException.class)
    public void create_user_with_existing_username() {
        sut.create(USER_1.getUsername(),"first", "last",  USER_3.getPassword(), "ROLE_USER");
    }

    @Test(expected = IllegalArgumentException.class)
    public void create_user_with_null_password() {
        sut.create(USER_3.getUsername(),"first", "last",  null, "ROLE_USER");
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User(-1L, "new", "user", "ROLE_USER","first","last");
